...
namespace Build_A_Bot
{
    ...
    public class Effector : Segment
    {
        ...
        private void DrawGrabber(Graphics g, float jointWidth)
        {   // Pomoshna funkcija za iscrtuvanje na Pipalo
        ...
        private void DrawLaser(Graphics g, float jointWidth)
        {   // Pomoshna funkcija za iscrtuvanje na laser
            Color jointColour = Color.FromArgb(98, 100, 102);
            Pen p = new Pen(this.Colour, 10.0f);
            Brush b = new SolidBrush(jointColour);
